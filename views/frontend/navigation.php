        ...
        <div class="navbar-nav flex-row order-md-last">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                    <a href="<?php echo ADMIN_URL ?>" class="dropdown-item">Admin Panel</a>
                ...
                <div class="row flex-fill align-items-center">
                    <div class="col">
                        <ul class="navbar-nav">
                            ...
                            <!-- create the loop for category-->


                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo BASE_URL ?>category.php">
                                    <span class="nav-link-title">
                                        Category Name
                                    </span>
                                </a>
                            ...
                            <!-- create the loop for category which have subcateogry-->
